REVOKE EXECUTE ON FUNCTION public.schedule_plan_expiry_reminders(text, text) FROM authenticated;
GRANT EXECUTE ON FUNCTION public.schedule_plan_expiry_reminders(text, text) TO service_role;
...
REVOKE ALL ON FUNCTION public.schedule_plan_expiry_reminders(text, text) FROM public, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.schedule_plan_expiry_reminders(text, text) TO service_role;